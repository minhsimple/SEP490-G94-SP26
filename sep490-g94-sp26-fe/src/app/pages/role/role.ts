          ...
          <div class="flex flex-col gap-6">
            <div>
              <label class="block font-bold mb-3"
                >Mã vai trò <span class="text-red-500">*</span></label
              >
              <input
                type="text"
                pInputText
              ...
              />
              <small class="text-red-500" *ngIf="submitted && !role.code"
                >Mã vai trò là bắt buộc.</small
              >
            </div>

            <div>
              <label class="block font-bold mb-3"
                >Tên vai trò <span class="text-red-500">*</span></label
              >
              <input
                type="text"
                pInputText
              ...
              />
              <small class="text-red-500" *ngIf="submitted && !role.name"
        ...
        .subscribe({
          ...
          error: (err) => {
            this.messageService.add({
              severity: 'error',
              summary: 'Lỗi',
              detail: err.error?.message || 'Tạo vai trò thất bại',
              life: 3000,
            });
            this.saving = false;
          },
