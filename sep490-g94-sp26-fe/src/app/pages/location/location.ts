          ...
          <tr>
            ...
            <td>
              <div class="flex items-center gap-3">
                <div
                  class="flex items-center justify-center w-10 h-10 rounded-full bg-green-100 text-green-600 font-semibold"
                >
            ...
            <td><i class="pi pi-home mr-2 text-gray-400"></i>{{ location.address || '-' }}</td>
          ...
          <div class="flex flex-col gap-6">
            <div>
              <label class="block font-bold mb-3"
                >Mã chi nhánh <span class="text-red-500">*</span></label
              >
              <input
                type="text"
                pInputText
              ...
              />
              <small class="text-red-500" *ngIf="submitted && !location.code"
                >Mã chi nhánh là bắt buộc.</small
              >
            </div>
            ...
            <div>
              ...
              />
              <small class="text-red-500" *ngIf="submitted && !location.name"
                >Tên chi nhánh là bắt buộc.</small
              >
            </div>
        ...
        .subscribe({
          ...
          error: (err) => {
            this.messageService.add({
              severity: 'error',
              summary: 'Lỗi',
              detail: err.error?.message || 'Tạo chi nhánh thất bại',
              life: 3000,
            });
            this.saving = false;
          },
