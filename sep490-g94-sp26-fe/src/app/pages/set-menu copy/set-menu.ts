                            ...
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-500 mt-1" *ngIf="menu.description">{{ menu.description }}</div>
                                    </div>
                                </div>
                            </td>
                ...
                <ng-template #content>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <!-- <div>
                            ...
                            <div *ngIf="!editingMenu.menuItems?.length" class="text-center py-4 text-500 text-sm border-round"
                                 style="border: 1px dashed #e2e8f0;">
                                Chưa có món ăn. Nhấn "Thêm món" để bắt đầu.
                            </div>

                            <div class="flex flex-col gap-3" *ngIf="editingMenu.menuItems?.length > 0">
...
export class SetMenu2Component implements OnInit {
    ...
    editSetMenu(menu: SetMenu) {
        this.setMenuService.getById(menu.id).subscribe({
            ...
            error: () => {
                this.editingMenu = {
                    ...menu,
                    locationId: (menu as any).location?.id ?? menu.locationId,
                    menuItems: (menu as any).menuItems ?? []
                };
